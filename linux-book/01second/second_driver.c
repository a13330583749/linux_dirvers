...
#define NAME         "LED_gtq_inter_second"
#define LED_ON       1
#define LED_OFF      0
#define SECPND_MAJOR 300

static int second_major = SECPND_MAJOR;
...
static irqreturn_t interrupt_handler(int iqr, void *dev_id)
{
    struct leddev_gtq *dev = (struct leddev_gtq *)dev_id;
...
{
    int retvalue;
    struct leddev_gtq* dev_led = dev->dev
